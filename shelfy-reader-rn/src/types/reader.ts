 ...
 *
 * All format-specific engines implement the ReaderEngineRef interface
 * so the reader container can control them uniformly.
 */
...
/**
 * Common ref interface that all format engines expose.
 * The reader container calls these methods to drive navigation, search, etc.
 *
 * Note: DOM-specific methods (getContentDocuments, getVisibleRange) from the
 * web version have been removed as they reference browser DOM types.
 */
