 ...
 * Contains all SQL statements for table creation, indexes, migrations, and seed data.
 * Copied from the Ionic/Capacitor app -- same 19 tables.
 */
...
// Database name
export const DB_NAME = 'shelfy-reader.db';
...
export const CREATE_TABLES = {
  ...
  [TABLES.READING_PROGRESS]: `
    CREATE TABLE IF NOT EXISTS ${TABLES.READING_PROGRESS} (
      ...
      chapter_id TEXT,
      chapter_title TEXT,
      furthest_progress REAL DEFAULT 0,
...
// Also create reading_sessions table (added via migration 6 in the original app)
...
export function getAllCreateStatements(): string[] {
  return [...Object.values(CREATE_TABLES), CREATE_READING_SESSIONS];
}
