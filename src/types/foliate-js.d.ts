 ...
 *
 * foliate-js ships no types, so we declare only the subset we use.
 */
...
declare module 'foliate-js/view.js' {
  ...
  export interface FoliateSearchYield {
    /** Present when the result is for a whole section */
    label?: string;
    subitems?: Array<{ cfi: string; excerpt: string }>;
    /** Present for individual results */
    cfi?: string;
    excerpt?: string;
    /** Present for progress updates */
    progress?: number;
  }
}
