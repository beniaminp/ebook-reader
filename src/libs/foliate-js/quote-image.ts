...
const fit = (el: HTMLElement, a: number = 1, b: number = 50): void => {
...
customElements.define(
    ...
    class extends HTMLElement {
        ...
        async getBlob({ title, author, text }: QuoteData): Promise<Blob | null> {
            ...
            fit(this.#root.querySelector('main') as HTMLElement)
